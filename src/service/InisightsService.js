    ...
    _trainModelFromDataset() {
        try {
            ...
            dataset.forEach(user => {
                ...
                clusterGroups[cluster].sumMaterialsPerDay += (user.materials_per_day || 0);
                clusterGroups[cluster].sumAvgRating += (user.avg_submission_rating_journey || 0);
            ...
            console.log("   -> Centroids terbentuk:", Object.keys(this._modelCentroids).length, "Clusters");
